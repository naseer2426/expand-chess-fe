...
import { EVENT_CONNECT, EVENT_JOIN_GAME, EVENT_SYNC_GAME, EVENT_SYNC_MOVE, socket } from "@/socket";
...
export default function GamePage() {
    ...
    const [clientInfo, setClientInfo] = useState<ClientInfo>({ type: "spectator", color: "white" })
    ...
    useEffect(() => {
        ...
        const onSync = (resp: SyncGame) => {
            ...
            if (resp.game.gameStatus != GameStatusNotStarted && resp.game.gameStatus != GameStatus.IN_PROGRESS) {
        ...
        <div className="flex items-center justify-center h-screen w-screen">
            <div className="flex w-1/2 p-10">
                <Chessboard
                    ...
                    areArrowsAllowed={false} arePremovesAllowed={false}
